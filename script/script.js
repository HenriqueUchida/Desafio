...
function atualizarPlcar(controleRodada){
    for(var i = 0; i < data.length; i++) {
        if (data[i].rodada == controleRodada && data[i].grupo == 'A'){
